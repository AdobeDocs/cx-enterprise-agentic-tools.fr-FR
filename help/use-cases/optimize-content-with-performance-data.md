...
| Outils agentiques | [Passerelle de collaborateur CX](../tools/mcp-servers.md#cx-coworker-gateway), [Serveur AEM Content MCP](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/using-mcp-with-aem-as-a-cloud-service) |
