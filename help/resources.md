...
| [Documentation Real-Time CDP MCP](https://experienceleague.adobe.com/en/docs/experience-cloud-ai/experience-cloud-ai/mcp/mcp-product-tools/rtcdp-mcp) | Guide de configuration du serveur MCP RTCDP |
...
| Ressource | Ce que vous trouverez |
|---|---|
| [Adobe Developer Console](https://developer.adobe.com/developer-console/docs/guides/) | Configuration du projet d’API, authentification et gestion des informations d’identification |
| [Guide de prise en main du développeur](https://developer.adobe.com/dep/) | Présentation de la création avec les API Adobe |

## Configuration du client d’IA

| Ressource | Ce que vous trouverez |
|---|---|
| [Documentation Claude Code MCP](https://docs.anthropic.com/en/docs/claude-code/mcp) | Comment ajouter des serveurs MCP à Claude Code |
| [Présentation du code Claude](https://docs.anthropic.com/en/docs/claude-code/overview) | Prise en main de Claude Code |
